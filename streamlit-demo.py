...
def inference():
    ...
    sub_title_cfg = """<div><h4 style="color:#042AFF; text-align:center; 
                    ...
                    Fibre Optic Connector detector for - 0W7981ALF 🚀</h4>
                    </div>"""

    # Set html page configuration
    st.set_page_config(page_title="Demo App", layout="wide", initial_sidebar_state="auto")
    ...
    with st.spinner("Model is downloading..."):
        model = YOLO('models/0w7981alf-small.pt')  # Load the YOLO model
    ...
    counter_display = st.markdown(f"<div><center><h5>Count : 0 </h5></center></div>", unsafe_allow_html=True)
    ...
    if st.sidebar.button("Start"):
        ...
        while videocapture.isOpened():
            ...
            counter_display.markdown(f"<div><center><h5>Count : {len(results[0].boxes.xyxy.cpu())}</h5></center></div>", unsafe_allow_html=True)
